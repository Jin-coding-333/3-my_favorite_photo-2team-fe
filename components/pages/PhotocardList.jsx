...
export default function PhotocardList({ page = 'myGallery' }) {
  ...
  switch (page) {
    case 'marketPlace':
      cardListData.photocardUrl = 'market-place/photocard';
      cardListData.cardType = 'original';
      break;
    case 'myGallery':
      cardListData.photocardUrl = 'my-gallery/my-photocard';
      cardListData.cardType = 'myCard';
      break;
    case 'mySalePhotocard':
      cardListData.photocardUrl = 'market-place/photocard';
      cardListData.cardType = 'forSale';
      break;
    default:
      break;
  }
    ...
    <div className={styles.photocardListContainer}>
      {photocards.map((photocard) => (
        <div className={styles.photocard}>
          <Link href={`/${cardListData.photocardUrl}/${photocard.id}`}>
            <PhotoCard
              key={photocard.id}
              cardType={cardListData.cardType}
