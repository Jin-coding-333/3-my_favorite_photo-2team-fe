...
export default function Modal({ isOpen, onClose, onConfirm, type, Data = {} }) {
  ...
  const modalTypes = {
    ...
    exchangeApproval: {
      ...
      message: (
        <>
          [{Data.grade} | {Data.cardName}] 카드와의 교환을 승인하시겠습니까?
        </>
      ),
    ...
    exchangeRejection: {
      ...
      message: (
        <>
          [{Data.grade} | {Data.cardName}] 카드와의 교환을 거절하시겠습니까?
        </>
      ),
    ...
    buyPhotoCard: {
      ...
      message: (
        <>
          [{Data.grade} | {Data.cardName}] {Data.count}장을 구매하시겠습니까?
        </>
      ),
